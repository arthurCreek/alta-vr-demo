...
export default function Footer() {
  return (
    <div className="footer-container py-8 lg:py-20 px-4 flex flex-col gap-6 items-center">
      <div>
        <a className="gray-dark font-semibold hover:text-yellow-400 cursor-pointer josefine-font lg:text-sm">DOWNLOAD A TOWNSHIP TALE</a>
      </div>
      <div className="w-10/12 lg:w-f flex gap-4 justify-center md:gap-8">
        ...
        >
          <svg
            ...
            className="w-8 lg:w-8 fill-current"
          >
            <path d="M1024,512C1024,229.23,794.77,0,512,0S0,229.23,0,512c0,255.55,187.23,467.37,432,505.78V660H302V512h130V399.2C432,270.88,508.44,200,625.39,200C681.41,200,740,210,740,210v126h-64.56c-63.6,0-83.44,39.47-83.44,79.96V512h142l-22.7,148H592v357.78C836.77,979.37,1024,767.55,1024,512z"></path>
          </svg>
        </a>
        {/* YouTube */}
        <a
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 511.25 511.36"
            className="w-8 lg:w-8 fill-current"
          >
            <path d="M255.7,0C114.48,0,0,114.45,0,255.67s114.48,255.7,255.7,255.7,255.7-114.48,255.7-255.7S396.92,0,255.7,0ZM419.56,317.39a76.77,76.77,0,0,1-7.08,24.77c-7.18,14.5-19.61,21.18-35.17,22.5-38.79,3.3-77.7,3.25-116.16,4-36.48-.85-72.56-.86-108.58-3.12a113.06,113.06,0,0,1-19.2-2.77C119,359.39,109.29,351,104.14,337c-4.9-13.32-5.92-27.24-6.72-41.14-2-35.06-2-70.11,1.86-105.07a74.21,74.21,0,0,1,7.7-26.64c7.74-14.73,20.94-20.76,36.75-21.83,57.6-3.91,115.27-3.89,173-2.66,18.27.39,36.54,1.14,54.78,2.38,27.74,1.87,41.24,13.3,46.88,40.6,2.73,13.22,3.5,26.71,3.86,40.14C423,254.34,423.5,285.94,419.56,317.39Z"></path>
            <polygon points="226.19 295.81 314 250.33 226.22 204.54 226.19 295.81"></polygon>
          </svg>
        </a>
        {/* Twitter */}
        <a
        ...
        >
          <svg
            ...
            className="w-8 lg:w-8 fill-current"
          >
            <path d="M18,0A18,18,0,1,0,36,18,18,18,0,0,0,18,0ZM29.93,23c-.2,4.36-2.63,6.78-7,7C21.67,30,21.26,30,18,30s-3.67,0-4.95-.07c-4.36-.2-6.78-2.62-7-7C6,21.67,6,21.26,6,18s0-3.67.07-4.95c.2-4.36,2.63-6.78,7-7C14.33,6,14.74,6,18,6s3.67,0,4.95.07c4.36.2,6.78,2.63,7,7C30,14.33,30,14.74,30,18S30,21.67,29.93,23Z"></path>
            <path d="M22.85,8.23c-1.27-.06-1.65-.07-4.85-.07s-3.58,0-4.85.07c-3.25.15-4.77,1.69-4.92,4.92-.06,1.27-.07,1.65-.07,4.85s0,3.58.07,4.85c.15,3.22,1.66,4.77,4.92,4.92,1.27.06,1.65.07,4.85.07s3.58,0,4.85-.07c3.25-.15,4.77-1.69,4.92-4.92.06-1.26.07-1.64.07-4.85s0-3.58-.07-4.85C27.62,9.92,26.1,8.38,22.85,8.23ZM18,24.16A6.16,6.16,0,1,1,24.16,18,6.16,6.16,0,0,1,18,24.16ZM24.41,13a1.44,1.44,0,1,1,1.43-1.44A1.43,1.43,0,0,1,24.41,13Z"></path>
